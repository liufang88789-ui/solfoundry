...
class TestWalletAuth:
    ...
    def test_get_wallet_auth_message(self, client, test_keypair):
        ...
        response = client.get(f"/api/auth/wallet/message?wallet_address={wallet_address}")
    ...
    def test_wallet_authenticate_invalid_signature(self, client, test_keypair):
        ...
        msg_response = client.get(f"/api/auth/wallet/message?wallet_address={wallet_address}")
